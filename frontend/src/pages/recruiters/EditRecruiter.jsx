...
const EditRecruiter = () => {
  ...
  const loadRecruiter = async () => {
    ...
    const { r_username, company } = data.data;
    setProfile((prev) => ({
      ...prev,
      r_username: r_username,
      c_city: company.c_city,
      c_zip: company.c_zip,
      c_street: company.c_street,
      c_country: company.c_country,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await fetch(`/api/v1/recruiters/profile/edit/${username}`, {
        method: "PUT",
        headers: {
      ...
      toast.success("Recruiter info Updated successfully!");
