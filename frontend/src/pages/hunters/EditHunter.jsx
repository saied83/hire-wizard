...
const EditHunter = () => {
  ...
  const handleHunter = async () => {
    try {
      ...
      console.log("Error in parsing hunter data", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await fetch(`/api/v1/hunters/profile/edit/${userName}`, {
        method: "PUT",
        headers: {
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={profile.bio}
                    onChange={handleChange}
                    className="shadow-sm mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm pl-4"
